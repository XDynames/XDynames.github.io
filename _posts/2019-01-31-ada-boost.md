...
Introduction
============
<img align="right" src="./Figures/weaklearnermisclass.png" width="350" height="325">
...
Implementation
==============
<img align="right" src="./Figures/WorkFlow.png" width="250" height="300">
<p style='text-align: justify;'>
...
|<img src="./Figures/LettersIterations1.png" width = "350" height = "300" alt="Training and testing accuracies for the implemented AdaBoost algorithm
on the Letters dataset."/>|<img src="./Figures/EmailIterations1.png" width = "350" height = "300" alt="Training and testing accuracies for the implemented AdaBoost algorithm
...
<div style="text-align:center">
|<img src="./Figures/LettersIterationsSKlearn.png" width = "350" height = "300" alt="Training and testing accuracies for the imported AdaBoost algorithm
for different ensemble sizes on the Letters dataset."/>|<img src="./Figures/EmailIterationsSKlearn.png" width = "350" height = "300" alt="Training and testing accuracies for the imported AdaBoost algorithm
...
<div style="text-align:center">
|<img src="./Figures/SigmaTuneLetters.png" width = "350" height = "300" alt="Training and testing accuracies for the imported Support Vector
Machine using a Gaussian kernel with different \(\sigma\) values. The
algorithm was applied to the Letters dataset."/>|<img src="./Figures/SigmaTuneEmails.png" width = "350" height = "300" alt="Training and testing accuracies for the imported Support Vector
Machine using a Gaussian kernel with different \(\sigma\) values. The
